...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.wl.app.domain.IOSQualification.class.getName(), jcacheConfiguration);
            cm.createCache(com.wl.app.domain.DdnUpdate.class.getName(), jcacheConfiguration);
            cm.createCache(com.wl.app.domain.Browse.class.getName(), jcacheConfiguration);
