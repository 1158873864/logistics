...
public class LogisticsDdnWWWServiceImpl implements LogisticsDdnWWWService {
	...
	@Override
	public Page<LogisticsDdnWWW> find(String query, Pageable pageable) {
		List<LogisticsDdnWWW> logisticsDdnWWWS=logisticsDdnWWWRepository.findAll();
		List<LogisticsDdnWWW> sortedList=new ArrayList<>();
		for(int i=0;i<logisticsDdnWWWS.size();i++){
			LogisticsDdnWWW logisticsDdnWWW=logisticsDdnWWWS.get(i);
			if(logisticsDdnWWW.getLogisticsDdn().getTitle().indexOf(query)!=(-1)||(logisticsDdnWWW.getMobilePhone()!=null&&logisticsDdnWWW.getMobilePhone().indexOf(query)!=(-1))||(logisticsDdnWWW.getContacts()!=null&&logisticsDdnWWW.getContacts().indexOf(query)!=(-1))||(logisticsDdnWWW.getName()!=null&&logisticsDdnWWW.getName().indexOf(query)!=(-1))||(logisticsDdnWWW.getPhone()!=null&&logisticsDdnWWW.getPhone().indexOf(query)!=(-1))||(logisticsDdnWWW.getRemark()!=null&&logisticsDdnWWW.getRemark().indexOf(query)!=(-1))||String.valueOf(logisticsDdnWWW.getId()).indexOf(query)!=(-1)){
				sortedList.add(logisticsDdnWWW);
			}
		}
