...
public class Sms {
	...
	public final static String ALIYUN_SMS_CONTACT_TEMPLATE_CODE2 = "SMS_166476678";
	...
	public String sendContact2(String mobilePhone,String userMobilePhone) {
		SendSmsResponse response = null;
		try {
			response = AliyunSms.sendSmsContact(mobilePhone, SMS_SIGN, ALIYUN_SMS_CONTACT_TEMPLATE_CODE2, userMobilePhone);
			System.out.println(response.getMessage());
			if(response.getCode().equals("OK")) {
				return SEND_SUCCESS;
			}
