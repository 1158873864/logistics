...
export class LogisticsDdnComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.logisticsDdnService
                ...
                .subscribe(
                    (res: HttpResponse<ILogisticsDdn[]>) => this.paginateLogisticsDdns(res.body, res.headers),
    ...
    registerChangeInLogisticsDdns() {
        this.eventSubscriber = this.eventManager.subscribe('logisticsDdnListModification', response => this.loadAll());
    }
