...
export class LogisticsDdnPicComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.logisticsDdnPicService
        ...
        .subscribe(
          (res: HttpResponse<ILogisticsDdnPic[]>) =>
            this.paginateLogisticsDdnPics(res.body, res.headers),
  ...
  registerChangeInLogisticsDdnPics() {
    this.eventSubscriber = this.eventManager.subscribe(
      "logisticsDdnPicListModification",
  ...
  private paginateLogisticsDdnPics(
    data: ILogisticsDdnPic[],
    headers: HttpHeaders
  ) {
